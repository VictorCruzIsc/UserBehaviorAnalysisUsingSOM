...
public class Package {
	...
	private boolean processPackage(String rawData){
		String[] dividedRawData = rawData.split(",");
		
		if(dividedRawData.length != 10){
			return true;
		}
		
		String localIp = dividedRawData[1];
		String destinationIp = dividedRawData[2];
		
		if(localIp.equals("FF") || localIp.equals("FE") ||
				destinationIp.equals("FF") || destinationIp.equals("FE")){
			return true;
		}
